...
describe("Verify CSV", function () {
    it("Inject Token And Verify CSV", function () { return __awaiter(void 0, void 0, void 0, function () {
        var prodText;
        return __generator(this, function (_a) {
            ...
            cy.readFile("cypress/downloads/order-invoice_fagun.qa.csv").then(function (text) {
                return __awaiter(this, void 0, void 0, function () {
                    var csvObj, csvProductName;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, neat_csv_1["default"](text)];
                            case 1:
                                csvObj = _a.sent();
                                console.log(csvObj);
                                csvProductName = csvObj[0]["Product Name"];
...
//# sourceMappingURL=CSS_VERIFY.js.map
